...
public class DebuggingQuteTemplateTest {
    ...
    public void debuggingTemplate() throws Exception {
        ...
        Thread[] threads = client.getThreads();
        ...
        /*
         * Variable secondVar = variables[1]; assertEquals("io.quarkus.qute.dataMap",
         * secondVar.getName()); assertEquals("true", secondVar.getValue());
