...
import io.quarkus.qute.parser.expression.scanner.ExpressionScanner;
import io.quarkus.qute.parser.expression.scanner.TokenType;
import io.quarkus.qute.parser.template.Expression;
import io.quarkus.qute.parser.template.Node;
import io.quarkus.qute.parser.template.TemplateNode;
...
public class ExpressionParser {
    ...
    public static List<Node> parse(Expression expression, boolean canSupportInfixNotation,
        ...
        TemplateNode template = expression.getOwnerTemplate();
