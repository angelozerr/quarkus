...
import io.quarkus.qute.parser.injection.InjectionDetector;
import io.quarkus.qute.parser.injection.InjectionMetadata;
import io.quarkus.qute.parser.injection.LanguageInjectionNode;
import io.quarkus.qute.parser.injection.scanner.ScannerWithInjection;
import io.quarkus.qute.parser.scanner.Scanner;
import io.quarkus.qute.parser.template.scanner.ScannerState;
import io.quarkus.qute.parser.template.scanner.TemplateScanner;
import io.quarkus.qute.parser.template.scanner.TokenType;
import io.quarkus.qute.parser.template.sections.CaseSection;
import io.quarkus.qute.parser.template.sections.DefaultSectionFactory;
import io.quarkus.qute.parser.template.sections.ElseSection;
import io.quarkus.qute.parser.template.sections.IsSection;
import io.quarkus.qute.parser.template.sections.SectionFactory;
...
public class TemplateParser {
    ...
    public static void parse(TemplateNode template) {
        parse(template, Collections.emptyList(), CancelChecker.NO_CANCELLABLE);
    }

    public static void parse(TemplateNode template, Collection<InjectionDetector> injectionDetectors) {
        parse(template, injectionDetectors, CancelChecker.NO_CANCELLABLE);
    }

    public static void parse(TemplateNode template, Collection<InjectionDetector> injectionDetectors,
            CancelChecker cancelChecker) {
        parse(template, DEFAULT_SECTION_FACTORY, injectionDetectors, cancelChecker);
    }

    public static TemplateNode parse(TemplateNode template, SectionFactory sectionFactory,
